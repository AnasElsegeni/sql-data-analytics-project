...
\* `gold.dim\_customers` — Customer information and demographic attributes.

\* `gold.dim\_products` — Product, category, subcategory, and cost information.

\* `gold.fact\_sales` — Sales transactions including orders, dates, quantities, prices, and sales amounts.
...
!\[Customer Report](./images/customer\_report.png)
...
!\[Product Report](./images/product\_report.png)
...
2\. Open `sql/data\_analytics.sql` in SQL Server Management Studio.
